...
flight=Image.open(r"portfolio/Image/Flight_Fare.jpg")
fifa=Image.open(r"portfolio/Image/Fifa20.jpg")
salary=Image.open(r"portfolio/Image/Texas_salary.jpg")
spam=Image.open(r"portfolio/Image/spam.png")
reviews=Image.open(r"portfolio/Image/Amazon_Reviews_analysis.jpg")
applied_ai=Image.open(r"portfolio/Image/applied_ai.png")
experience=Image.open(r"portfolio/Image/experience1.jpg")
iabac=Image.open(r"portfolio/Image/iabac_logo.jpg")
datamites=Image.open(r"portfolio/Image/datamites.png")
hackerrank=Image.open(r"portfolio/Image/HackerRank.png")
st.write("##")
